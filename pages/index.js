  ...
  return <div className='bg-primary/60 h-full'>
    ...
    <div className='w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10'>
      <div className='text-center flex flex-col justify-center xl:pt-40 xl:text-left h-full container mx-auto'>
        ...
        {/* subtitle */}
        <motion.p variants={fadeIn('down', 0.3)} initial='hidden' animate='show' exit='hidden' className='max-w-sm xl:max-w-xl mx-auto xl:mx-0 mb-10 xl:mb-16'>Navegando pelos códigos e dados, moldo o futuro digital com cada linha de código, em busca de soluções inovadoras e impactantes.</motion.p>
        {/* btn */}
